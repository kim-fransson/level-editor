...
const styles = tv({
  base: "group bg-dark-gray shadow-lg text-white text-xs rounded-lg p-1 text-center font-medium will-change-transform",
  variants: {
    isEntering: {
...
export const Tooltip = ({ children, ...props }: TooltipProps) => {
  return (
    ...
    >
      <OverlayArrow className="-top-[6.5px] text-dark-gray">
        <svg
          width="14"
          height="12"
          viewBox="0 0 14 12"
